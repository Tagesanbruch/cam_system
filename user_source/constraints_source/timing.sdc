...
set_clock_groups -exclusive -group [get_clocks {rgmii_rx_clk}]  -group [get_clocks { S_hdmi_clk }]  -group [get_clocks { clk_25m }] -group [get_clocks { cpu_clk_70m }] -group [get_clocks { cam_clk_27m }] -group [get_clocks { hs_rx_clk }] -group [get_clocks {u_uifdma_axi_ddr/u_ddr_phy/hctrl_clk}]
